...
func NotifyPolyaxonRunStatus(namespace, name, owner, project, uuid string, statusCond apiv1.OperationCondition, connections []string, log logr.Logger) error {
...
func LogPolyaxonRunStatus(owner, project, uuid string, statusCond apiv1.OperationCondition, log logr.Logger) error {
	token := config.GetStrEnv(PolyaxonAuthToken, "")
