...
func (r *ClusterReconciler) syncStatus(instance *apiv1.Cluster, statusCond apiv1.OperationCondition) error {
...
func (r *ClusterReconciler) collectLogs(instance *apiv1.Cluster) error {
