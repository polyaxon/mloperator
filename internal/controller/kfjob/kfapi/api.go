...
type RunPolicy struct {
	...
	// Default to Running.
	CleanPodPolicy *apiv1.CleanPodPolicy `json:"cleanPodPolicy,omitempty"`
...
type MPIJobSpec struct {
	...
	MPIReplicaSpecs map[apiv1.MPIReplicaType]*apiv1.KFReplicaSpec `json:"mpiReplicaSpecs"`
}

// PyTorchJobSpec is a desired state description of the PyTorchJob.
type PyTorchJobSpec struct {
	RunPolicy           RunPolicy                                         `json:"runPolicy,omitempty"`
	ElasticPolicy       *apiv1.PytorchElasticPolicy                       `json:"elasticPolicy,omitempty"`
	NprocPerNode        *string                                           `json:"nprocPerNode,omitempty"`
	PyTorchReplicaSpecs map[apiv1.PyTorchReplicaType]*apiv1.KFReplicaSpec `json:"pytorchReplicaSpecs"`
}
...
type TFJobSpec struct {
	...
	SuccessPolicy       *apiv1.TFSuccessPolicy                       `json:"successPolicy,omitempty"`
	TFReplicaSpecs      map[apiv1.TFReplicaType]*apiv1.KFReplicaSpec `json:"tfReplicaSpecs"`
}
