...
func (r *KfJobReconciler) AddLogsFinalizer(ctx context.Context, instance *apiv1.KfJob) error {
...
func (r *KfJobReconciler) AddStatusFinalizer(ctx context.Context, instance *apiv1.KfJob) error {
	controllerutil.AddFinalizer(instance, apiv1.OperationStatusFinalizer)
	return r.Update(ctx, instance)
}

func (r *KfJobReconciler) handleFinalizers(ctx context.Context, instance *apiv1.KfJob) error {
	log := r.Log
