...
func (r *KfJobReconciler) delete(ctx context.Context, instance *apiv1.KfJob) error {
	log := r.Log
...
func (r *KfJobReconciler) handleTTL(ctx context.Context, instance *apiv1.KfJob) (ctrl.Result, error) {
	log := r.Log
...
func (r *KfJobReconciler) handlePastActiveDeadline(ctx context.Context, instance *apiv1.KfJob) (*time.Duration, error) {
	log := r.Log
...
func (r *KfJobReconciler) getBackOff(backOff int32) time.Duration {
