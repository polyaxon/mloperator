...
func (r *JobReconciler) delete(ctx context.Context, instance *apiv1.Job) error {
	log := r.Log
...
func (r *JobReconciler) handleTTL(ctx context.Context, instance *apiv1.Job) (ctrl.Result, error) {
	log := r.Log
