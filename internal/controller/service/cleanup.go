...
func (r *ServiceReconciler) delete(ctx context.Context, instance *apiv1.Service) error {
	log := r.Log
...
func (r *ServiceReconciler) handleTTL(ctx context.Context, instance *apiv1.Service) (ctrl.Result, error) {
	log := r.Log
...
func (r *ServiceReconciler) handlePastActiveDeadline(ctx context.Context, instance *apiv1.Service) (*time.Duration, error) {
	log := r.Log
